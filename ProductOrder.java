...
public class ProductOrder
{
	...
	public boolean equals(Object other)
	{
		...
		ProductOrder otherP = (ProductOrder) other; //convert the other object to a ProductOrder object and assign to otherP
		if (this.orderNumber.equals(otherP.orderNumber)) { 		//if the current obejct's order number equals otherP's order number then return true else return false
			return true;
		}
		return false;
	}
