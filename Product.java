...
public class Product
{
	...
	public Product(String name, String id, double price, int stock, Category category)
	{
		...
		this.ratings = new Ratings(0, 0, 0, 0, 0, 0);
	}
	/*
	...
	{
		if ((productOptions.equals("")) || (productOptions==null)){	//check whether options valid or not
			return true;
		}
		return false;
	}
	...
	{
		return stockCount;				//return the stockcount of this product
	}
	/*
	...
	{
		this.stockCount = stockCount;			//set the current stockount to the value passed as parameter
	}
	/*
	...
	{
		stockCount--;			//reduce stockcount by 1
	}
	...
	{
		Product otherP = (Product) other;						//cast other to product object
		return this.id.equals(otherP.id);						//return if id are same or not
	}
}
